<?php
	if (isset($_POST['submit'])) {
		...
		if (mysqli_num_rows($sql2) > 0) {
				...
				$sql = "INSERT INTO user (account , passwd , name , phone, active) VALUES ('$account', '$passwd', '$name', '$phone', 'Y')";	
...
<body>
	<div class='container mb-5'>
		...
		<form action=<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?> method="post" style="padding-top:8%;padding-bottom:12%;padding-left:20%;padding-right:20%;">
			...
			<div class="form-group">
				<input type="text" class="form-control" placeholder="請輸入手機0912345678" name="phone" pattern='\d{10}' title="請輸入手機0912345678" required>
			</div>
