			...
			<?php
				if (isset($_POST['submit'])) {
					...
					if ($submit==1) {
						...
						$sql = "INSERT INTO goods_item01 (`item_name`) VALUES ('$item_name')";
						...
						$sql = "INSERT INTO goods_class01 (`class_name`) VALUES ('$class_name')";
						...
						$course_sql = mysqli_query($db, "SELECT max(goods_num) FROM goods01");
						...
						$nphoto = $nmax."-1.jpg";
						$sql = "INSERT INTO goods01 (item_num, class_num, goods_name, information, note, unit, price, photo, exist) VALUES ('$item_num', '$class_num', '$goods_name', '$information', '$note', '$unit', '$price', '$nphoto','0')";
						// echo $sql;
						// execute query
					...
					<form action="商品登錄" method="POST" enctype="multipart/form-data">
						...
						<div class="row">
							<div class="col-sm-12 col-md-6 col-lg-2">
								...
								<?php
									require 'db_login.php';
									$sql = mysqli_query($db, "SELECT * FROM goods_item01");
							...
							<div class="col-sm-12 col-md-6 col-lg-2">
								...
								<?php
									require 'db_login.php';
									$sql = mysqli_query($db, "SELECT * FROM goods_class01");
									while ($row = mysqli_fetch_array($sql)) {
