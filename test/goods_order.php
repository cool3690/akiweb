...
<body>
	<div class="container" style="padding-bottom:8%;">
		<?php 
			...
			error_reporting(0);
			$check=0;
			echo '<h3 class="text-center mt-3">商品訂單查詢</h3>';
			echo '<table class="table table-bordered text-center"><thead><tr><th>訂單編號</th><th>訂購日期</th><th>商品</th><th>品牌名稱</th><th width="20%">數量</th><th>單價</th><th>小計</th></tr></thead>';		
			$gorder_sql = mysqli_query($db, "SELECT * FROM goods_order where account='$account'");
