				...
				<form method="post" action="clsm_update.php" style="padding-top:2%;padding-bottom:10%;padding-left:2%;padding-right:2%;">
					...
					<div class="row text-center" style="line-height:4;letter-spacing:6px;">
						...
						for($i=1;$i<8 ;$i++){
							...
							echo '<div class="col-lg-2 mb-3">
								<select class="form-control" name="strength'.$i.'">';
									$strength_sql = mysqli_query($db, "SELECT * FROM 28strength order by snum ASC");
									
									while ($row_strength = mysqli_fetch_array($strength_sql)) {
										echo '<option value="'.$row_strength['snum']."-".$row_strength['enum'].'"'; echo $row["$strength"] == $row_strength['snum']."-".$row_strength['enum']?" selected":""; echo '>'.$row_strength['snum']."-".$row_strength['enum'].'</option>';
									}
								echo '
								</select>
							</div>
							...
							<div class="col-lg-2">
								<input type="text" class="form-control" name="number'.$i.'" value="'.$row["$number"].'">
							</div>
							<div class="col-lg-1">
								<input type="text" class="form-control" name="price'.$i.'" value="'.$row["$price"].'">
							</div>
							<div class="col-lg-4">
						...
						<div style="line-height:4;padding-left:20px;letter-spacing:6px;">
							...
							<div class="form-check">
								<label class="form-check-label form-inline">
									<input type="checkbox" class="form-check-input" name="terms3_1" value="1"'; echo $row['terms3_1'] == "1"?" checked ":""; echo '>3．本報價單未含加值營業稅。&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="checkbox" class="form-check-input" name="terms3_2" value="1"'; echo $row['terms3_2'] == "1"?" checked ":""; echo '>．本報價單已含加值營業稅。
								</label>
							</div>	
							<div class="form-check">
								<label class="form-check-label form-inline">
									<input type="checkbox" class="form-check-input" name="terms4_1" value="1"'; echo $row['terms4_1'] == "1"?" checked ":""; echo '>4．本報價單未含試體試驗費。&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="checkbox" class="form-check-input" name="terms4_2" value="1"'; echo $row['terms4_2'] == "1"?" checked ":""; echo '>．本報價單已含試體試驗費。
								</label>
							</div>
							<div class="form-check">
