	...
	<div class="container" style="padding-bottom:8%">
		<div class="row mt-5">
			<div class="col-sm-12 col-md-12 col-lg-12">
				<div class="text-center"><i class="fas fa-square fa-rotate-45 mr-3" style="font-size:10px;"></i><span class="ml-3 mr-4" style="font-size:26px;font-weight:bold;">活動剪影</span><i class="fas fa-square fa-rotate-45 mr-3" style="font-size:10px;"></i></div>
			</div>
			...
			<?php				
				...
				switch ($id) {
					case 1:
						$text='<p class="mt-2 text-center">2019/09/29</p><p class="mt-3 text-center">與亞紀塾老師佩燕及壽司天團隊，<br>在星期日共渡了一場這麼美好的壽司野餐活動。</p>';
						break;
					case 2:
						$text='<p class="mt-2 text-center">2020/01/17</p>
							   <p class="mt-3 text-center">
									日本工作講座，第一場圓滿結束。<br>
									希望參加講座的各位，在2020年找到好工作。<br><br>

									感謝東海樂活主辦這個有意義的講座。
							   </p>';
						break;
					case 3:
						$text='<p class="mt-2 text-center">2020/02/07</p>
							   <p class="mt-3 text-center">
									2020亞紀塾日本語福岡旅行。<br>
									福岡市博多區 | 那值得回憶的數天。
							   </p>';
				...
				$j=2;
				$z=1001;
				$directory ='images/activity_photo/akky/'.$id.'/';
