...
<body>
	...
	<div class="container" style="padding-bottom:155px;">
			...
			<?php
				...
				//設定分頁
				$sql = "SELECT * FROM online_time a left join user b on a.account=b.account order by sdate DESC";
				...
				echo "
					...
					while ($row = mysqli_fetch_array($result)) {
						...
						echo "<tbody>
							...
							<td class='text-center align-middle'>".$row['account']."</p></td>
							<td class='text-center align-middle' style='line-height:30px;'> ".$row['name']."</td>
