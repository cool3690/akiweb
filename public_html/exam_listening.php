...
<body>
	...
	<div class="container mt-5" style="line-height:35px;padding-bottom:30px;">
		...
		<div class="row justify-content-center mt-5 mb-2">
			<button class="btn mt-2 mb-2 link1" id="1" name="1" value="1">初級一</button>
			<button class="btn mt-2 mb-2 link1" id="2" name="2" value="2">初級二</button>
			<button class="btn mt-2 mb-2 link1" id="3" name="3" value="3">進階一</button>
			<button class="btn mt-2 mb-2 link1" id="4" name="4" value="4">進階二</button>
		</div>
