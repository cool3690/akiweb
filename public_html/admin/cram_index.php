	...
	<div class="container-fluid">
		<div class="row pt-3" style="height:100px;background-color:#fff3e3">
			<div class="col-sm-12 col-md-2 col-lg-3">
				<a href="首頁"><img class="rounded float-right" src="images/logo01.gif"></a>
			</div>
	...
	<div class="container" id="marquee_height">	
		<div class="row" style="">
			<div class="col-sm-9 col-md-12 col-lg-12">
				<div>
				<img id="marquee1" class="text-center animated fadeInUp mx-auto d-block" src="images/topbg01.jpg">
				...
				<div id="marquee4">
					<a href="課程列表" target="_blank"><img src="images/course_floaticon.png" width="164" height="82" /></a>
				</div>
			</div>
		</div>			
	</div>	
								...
								echo '
									<div class="col-12 col-sm-12 col-md-12 col-lg-12 mt-2">	
										<div class="col-sm-12 col-md-12 col-lg-12">';
											...
											<p class="pl-5 ml-3" id="myBtn1" style="font-size:14px;color:#26D07C;">more >></p>
										</div>	
										...
										if (file_exists($file)) {	
											echo '
												<a data-fancybox="gallery" href="'.$file.'">
													<img src="'.$file.'" class="mx-auto d-block" id="new_img0" style="width:60%;left:65px;top:25px;">
												</a>';	
										} else {
											...
											if (file_exists($file2)) {
												echo '
													<a data-fancybox="gallery" href="'.$file2.'">
														<img src="'.$file2.'" class="mx-auto d-block" id="new_img0" style="width:60%;left:65px;top:25px;">
													</a>';	
											} 
										}							
								echo '</div>';
				...
				<div class="col-sm-3 col-md-3 col-lg-4" id="cram_right">
					<?php
						if(@$_SESSION['user_authorize']=='2'){
							echo '
								<p class="animated headShake">線上課程入口<span class="badge badge-pill badge-danger ml-3">New</span></p></p>
								<a href="直播觀看" target="_blank"><i class="fas fa-video fa-2x pl-4 text-info mb-5"></i></a>
							';
						}
					?>
