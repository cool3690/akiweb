			...
			<?php
				...
				while ($goods_row = mysqli_fetch_array($goods_sql)) {
					...
					if(@$_SESSION['admin']=='Y'){	
						...
						echo '<td class="align-middle">'.$goods_row['goods_num'].'
							<select class="form-control mt-4" name="exist[]">
						...
						echo '<td class="align-middle">
							...
							<select class="form-control mt-4" name="class_num[]">';
				...
				<!--				　	<option value="包み">包み</option>  -->
								...
								<input type="text" class="form-control mt-4" name="price[]" value="'.$goods_row['price'].'">
						</td>';
