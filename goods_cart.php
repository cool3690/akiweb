...
<img src="images/bg.jpg">
	<div class="container" style="padding-bottom:8%;">
		...
		<?php 
			...
			echo '<h3 class="text-center mt-3 mb-5">購物車</h3>';
			echo '<table class="table table-striped text-center"><thead><tr><th><input type="checkbox"  class="checkall"/></th><th>商品</th><th>品牌名稱</th><th width="10%">數量</th><th>單價</th><th>小計</th></tr></thead>';
