...
<body>
	...
	<script>
		...
		async function run() {
		  ...
		  // this:
		  //
			room = { url: 'https://akkyschoollive.daily.co/hello' }
		  //
		 ...
		 callFrame.join({ url: 'https://akkyschoollive.daily.co/hello' });
		  ...
		  // join the room
		  //
		  await callFrame.join({ url: 'https://akkyschoollive.daily.co/hello'});
